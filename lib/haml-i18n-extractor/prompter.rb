  ...
  module I18n
    class Extractor
      class Prompter
        ...
        def get_key_name
          answer = ask(highlight("Enter the key name for this in the yaml")) do |q|
            q.echo      = true
          end
          answer
        end
        ...
        def get_replacement_line
          answer = ask(highlight("Manually enter the replacement text for this line:")) do |q|
            q.echo      = true
          end
          answer
        end
